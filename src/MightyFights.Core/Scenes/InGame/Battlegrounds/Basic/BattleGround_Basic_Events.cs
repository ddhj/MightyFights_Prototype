...
{
	public partial class BattleGround_Basic
	{
		// PORT (2026 consolidation): ProcessBuffClick / ProcessHammerClick moved to
		// BattleSceneBase along with the rest of the drop economy.
		...
		// PORT (2026 consolidation): Register/UnRegisterHandlers + cursor MouseMove moved to
		// BattleSceneBase.
	}
}
